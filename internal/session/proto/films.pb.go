...
var file_proto_films_proto_rawDesc = []byte{
	...
	0x6c, 0x6d, 0x52, 0x05, 0x66, 0x69, 0x6c, 0x6d, 0x73, 0x32, 0xc4, 0x0d, 0x0a, 0x05, 0x46, 0x69,
	...
	0x00, 0x12, 0x56, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x46, 0x69, 0x6c, 0x6d, 0x44, 0x61, 0x74, 0x61,
	0x42, 0x79, 0x55, 0x75, 0x69, 0x64, 0x12, 0x1e, 0x2e, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x2e, 0x46, 0x69, 0x6c, 0x6d, 0x44, 0x61, 0x74, 0x61, 0x42, 0x79, 0x55, 0x75, 0x69, 0x64, 0x52,
	...
	,
...
var file_proto_films_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_proto_films_proto_goTypes = []interface{}{
	...
	(*TopFilm)(nil),                     // 50: session.TopFilm
	(*GetTopFilmsRequest)(nil),          // 51: session.GetTopFilmsRequest
	(*GetTopFilmsResponse)(nil),         // 52: session.GetTopFilmsResponse
	(*timestamppb.Timestamp)(nil),       // 53: google.protobuf.Timestamp
}
var file_proto_films_proto_depIdxs = []int32{
	1,  // 0: session.Season.episodes:type_name -> session.Episode
	53, // 1: session.FilmData.date:type_name -> google.protobuf.Timestamp
	...
	11, // 35: session.Films.GetFilmDataByUuid:input_type -> session.FilmDataByUuidRequest
	13, // 36: session.Films.GetFilmPreviewByUuid:input_type -> session.FilmPreviewByUuidRequest
	15, // 37: session.Films.GetAllFilmComments:input_type -> session.AllFilmCommentsRequest
	19, // 38: session.Films.RemoveFilmByUuid:input_type -> session.RemoveFilmByUuidRequest
	21, // 39: session.Films.GetActorDataByUuid:input_type -> session.ActorDataByUuidRequest
	23, // 40: session.Films.GetActorsByFilm:input_type -> session.ActorsByFilmRequest
	25, // 41: session.Films.PutFavorite:input_type -> session.PutFavoriteRequest
	27, // 42: session.Films.DeleteFavorite:input_type -> session.DeleteFavoriteRequest
	29, // 43: session.Films.GetAllFavoriteFilms:input_type -> session.GetAllFavoriteFilmsRequest
	31, // 44: session.Films.GetAllFilmsByGenre:input_type -> session.GetAllFilmsByGenreRequest
	33, // 45: session.Films.GetAllGenres:input_type -> session.GetAllGenresRequest
	40, // 46: session.Films.AddFilm:input_type -> session.AddFilmRequest
	42, // 47: session.Films.FindFilmsShort:input_type -> session.FindFilmsShortRequest
	42, // 48: session.Films.FindFilmsLong:input_type -> session.FindFilmsShortRequest
	42, // 49: session.Films.FindSerialsShort:input_type -> session.FindFilmsShortRequest
	42, // 50: session.Films.FindSerialsLong:input_type -> session.FindFilmsShortRequest
	46, // 51: session.Films.FindActorsShort:input_type -> session.FindActorsShortRequest
	46, // 52: session.Films.FindActorsLong:input_type -> session.FindActorsShortRequest
	51, // 53: session.Films.GetTopFilms:input_type -> session.GetTopFilmsRequest
	10, // 54: session.Films.GetAllFilmsPreviews:output_type -> session.AllFilmsPreviewsResponse
	12, // 55: session.Films.GetFilmDataByUuid:output_type -> session.FilmDataByUuidResponse
	14, // 56: session.Films.GetFilmPreviewByUuid:output_type -> session.FilmPreviewByUuidResponse
	16, // 57: session.Films.GetAllFilmComments:output_type -> session.AllFilmCommentsResponse
	20, // 58: session.Films.RemoveFilmByUuid:output_type -> session.RemoveFilmByUuidResponse
	22, // 59: session.Films.GetActorDataByUuid:output_type -> session.ActorDataByUuidResponse
	24, // 60: session.Films.GetActorsByFilm:output_type -> session.ActorsByFilmResponse
	26, // 61: session.Films.PutFavorite:output_type -> session.PutFavoriteResponse
	28, // 62: session.Films.DeleteFavorite:output_type -> session.DeleteFavoriteResponse
	30, // 63: session.Films.GetAllFavoriteFilms:output_type -> session.GetAllFavoriteFilmsResponse
	32, // 64: session.Films.GetAllFilmsByGenre:output_type -> session.GetAllFilmsByGenreResponse
	35, // 65: session.Films.GetAllGenres:output_type -> session.GetAllGenresResponse
	41, // 66: session.Films.AddFilm:output_type -> session.AddFilmResponse
	43, // 67: session.Films.FindFilmsShort:output_type -> session.FindFilmsShortResponse
	45, // 68: session.Films.FindFilmsLong:output_type -> session.FindFilmsLongResponse
	43, // 69: session.Films.FindSerialsShort:output_type -> session.FindFilmsShortResponse
	45, // 70: session.Films.FindSerialsLong:output_type -> session.FindFilmsLongResponse
	47, // 71: session.Films.FindActorsShort:output_type -> session.FindActorsShortResponse
	49, // 72: session.Films.FindActorsLong:output_type -> session.FindActorsLongResponse
	52, // 73: session.Films.GetTopFilms:output_type -> session.GetTopFilmsResponse
