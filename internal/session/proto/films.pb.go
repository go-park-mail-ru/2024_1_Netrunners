...
var file_proto_films_proto_rawDesc = []byte{
	...
	0x50, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x52, 0x06, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x73, 0x32,
	0xe2, 0x0b, 0x0a, 0x05, 0x46, 0x69, 0x6c, 0x6d, 0x73, 0x12, 0x5c, 0x0a, 0x13, 0x47, 0x65, 0x74,
...
var file_proto_films_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
...
var file_proto_films_proto_depIdxs = []int32{
	...
	41, // 1: session.FilmData.date:type_name -> google.protobuf.Timestamp
	2,  // 2: session.FilmData.seasons:type_name -> session.Season
	41, // 3: session.Comment.added_at:type_name -> google.protobuf.Timestamp
	41, // 4: session.ActorData.birthday:type_name -> google.protobuf.Timestamp
	...
	41, // 18: session.FildFilmLong.date:type_name -> google.protobuf.Timestamp
	...
	8,  // 21: session.Films.GetAllFilmsPreviews:input_type -> session.AllFilmsPreviewsRequest
	10, // 22: session.Films.GetFilmDataByUuid:input_type -> session.FilmDataByUuidRequest
	12, // 23: session.Films.GetFilmPreviewByUuid:input_type -> session.FilmPreviewByUuidRequest
	14, // 24: session.Films.GetAllFilmComments:input_type -> session.AllFilmCommentsRequest
	18, // 25: session.Films.RemoveFilmByUuid:input_type -> session.RemoveFilmByUuidRequest
	20, // 26: session.Films.GetActorDataByUuid:input_type -> session.ActorDataByUuidRequest
	22, // 27: session.Films.GetActorsByFilm:input_type -> session.ActorsByFilmRequest
	24, // 28: session.Films.PutFavorite:input_type -> session.PutFavoriteRequest
	26, // 29: session.Films.DeleteFavorite:input_type -> session.DeleteFavoriteRequest
	28, // 30: session.Films.GetAllFavoriteFilms:input_type -> session.GetAllFavoriteFilmsRequest
	30, // 31: session.Films.GetAllFilmsByGenre:input_type -> session.GetAllFilmsByGenreRequest
	32, // 32: session.Films.GetAllGenres:input_type -> session.GetAllGenresRequest
	35, // 33: session.Films.FindFilmsShort:input_type -> session.FindFilmsShortRequest
	35, // 34: session.Films.FindFilmsLong:input_type -> session.FindFilmsShortRequest
	35, // 35: session.Films.FindSerialsShort:input_type -> session.FindFilmsShortRequest
	35, // 36: session.Films.FindSerialsLong:input_type -> session.FindFilmsShortRequest
	39, // 37: session.Films.FindActorsShort:input_type -> session.FindActorsShortRequest
	9,  // 38: session.Films.GetAllFilmsPreviews:output_type -> session.AllFilmsPreviewsResponse
	11, // 39: session.Films.GetFilmDataByUuid:output_type -> session.FilmDataByUuidResponse
	13, // 40: session.Films.GetFilmPreviewByUuid:output_type -> session.FilmPreviewByUuidResponse
	15, // 41: session.Films.GetAllFilmComments:output_type -> session.AllFilmCommentsResponse
	19, // 42: session.Films.RemoveFilmByUuid:output_type -> session.RemoveFilmByUuidResponse
	21, // 43: session.Films.GetActorDataByUuid:output_type -> session.ActorDataByUuidResponse
	23, // 44: session.Films.GetActorsByFilm:output_type -> session.ActorsByFilmResponse
	25, // 45: session.Films.PutFavorite:output_type -> session.PutFavoriteResponse
	27, // 46: session.Films.DeleteFavorite:output_type -> session.DeleteFavoriteResponse
	29, // 47: session.Films.GetAllFavoriteFilms:output_type -> session.GetAllFavoriteFilmsResponse
	31, // 48: session.Films.GetAllFilmsByGenre:output_type -> session.GetAllFilmsByGenreResponse
	34, // 49: session.Films.GetAllGenres:output_type -> session.GetAllGenresResponse
	36, // 50: session.Films.FindFilmsShort:output_type -> session.FindFilmsShortResponse
	38, // 51: session.Films.FindFilmsLong:output_type -> session.FindFilmsLongResponse
	36, // 52: session.Films.FindSerialsShort:output_type -> session.FindFilmsShortResponse
	38, // 53: session.Films.FindSerialsLong:output_type -> session.FindFilmsLongResponse
	40, // 54: session.Films.FindActorsShort:output_type -> session.FindActorsShortResponse
