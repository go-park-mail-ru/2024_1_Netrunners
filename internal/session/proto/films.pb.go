...
type FilmPreview struct {
	...
	ScoresCount int64   `protobuf:"varint,6,opt,name=scores_count,json=scoresCount,proto3" json:"scores_count,omitempty"`
...
func (x *FilmPreview) GetScoresCount() int64 {
	if x != nil {
...
type FilmData struct {
	...
	ScoresCount int64                  `protobuf:"varint,7,opt,name=scores_count,json=scoresCount,proto3" json:"scores_count,omitempty"`
...
func (x *FilmData) GetScoresCount() int64 {
	if x != nil {
		return x.ScoresCount
	}
	return 0
...
var file_proto_films_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x65, 0x73, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x73, 0x63, 0x6f, 0x72,
	...
	0x74, 0x6f, 0x72, 0x73, 0x32, 0x81, 0x05, 0x0a, 0x05, 0x46, 0x69, 0x6c, 0x6d, 0x73, 0x12, 0x5c,
...
var file_proto_films_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
...
var file_proto_films_proto_depIdxs = []int32{
	22, // 0: session.FilmData.date:type_name -> google.protobuf.Timestamp
	22, // 1: session.Comment.added_at:type_name -> google.protobuf.Timestamp
	22, // 2: session.ActorData.birthday:type_name -> google.protobuf.Timestamp
	...
	6,  // 11: session.Films.GetAllFilmsPreviews:input_type -> session.AllFilmsPreviewsRequest
	8,  // 12: session.Films.GetFilmDataByUuid:input_type -> session.FilmDataByUuidRequest
	10, // 13: session.Films.GetFilmPreviewByUuid:input_type -> session.FilmPreviewByUuidRequest
	12, // 14: session.Films.GetAllFilmComments:input_type -> session.AllFilmCommentsRequest
	16, // 15: session.Films.RemoveFilmByUuid:input_type -> session.RemoveFilmByUuidRequest
	18, // 16: session.Films.GetActorDataByUuid:input_type -> session.ActorDataByUuidRequest
	20, // 17: session.Films.GetActorsByFilm:input_type -> session.ActorsByFilmRequest
	7,  // 18: session.Films.GetAllFilmsPreviews:output_type -> session.AllFilmsPreviewsResponse
	9,  // 19: session.Films.GetFilmDataByUuid:output_type -> session.FilmDataByUuidResponse
	11, // 20: session.Films.GetFilmPreviewByUuid:output_type -> session.FilmPreviewByUuidResponse
	13, // 21: session.Films.GetAllFilmComments:output_type -> session.AllFilmCommentsResponse
	17, // 22: session.Films.RemoveFilmByUuid:output_type -> session.RemoveFilmByUuidResponse
	19, // 23: session.Films.GetActorDataByUuid:output_type -> session.ActorDataByUuidResponse
	21, // 24: session.Films.GetActorsByFilm:output_type -> session.ActorsByFilmResponse
