...
const (
	...
	Sessions_GenerateToken_FullMethodName             = "/session.Sessions/GenerateToken"
)
...
func (c *sessionsClient) Add(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error) {
	out := new(AddResponse)
	err := c.cc.Invoke(ctx, Sessions_Add_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionsClient) DeleteSession(ctx context.Context, in *DeleteSessionRequest, opts ...grpc.CallOption) (*DeleteSessionResponse, error) {
	...
	err := c.cc.Invoke(ctx, Sessions_DeleteSession_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionsClient) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateRequestResponse, error) {
	...
	err := c.cc.Invoke(ctx, Sessions_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionsClient) CheckVersion(ctx context.Context, in *CheckVersionRequest, opts ...grpc.CallOption) (*CheckVersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, Sessions_CheckVersion_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionsClient) GetVersion(ctx context.Context, in *GetVersionRequest, opts ...grpc.CallOption) (*GetVersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, Sessions_GetVersion_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionsClient) HasSession(ctx context.Context, in *HasSessionRequest, opts ...grpc.CallOption) (*HasSessionResponse, error) {
	...
	err := c.cc.Invoke(ctx, Sessions_HasSession_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionsClient) CheckAllUserSessionTokens(ctx context.Context, in *CheckAllUserSessionTokensRequest, opts ...grpc.CallOption) (*CheckAllUserSessionTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, Sessions_CheckAllUserSessionTokens_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionsClient) GenerateToken(ctx context.Context, in *GenerateTokenRequest, opts ...grpc.CallOption) (*GenerateTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, Sessions_GenerateToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Sessions_GenerateToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Sessions_GenerateToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
